...
//    when(content.getWebtoonImageUrl()).thenReturn("webtoon/image.jpg");
...
//  @Test
//  @DisplayName(
//      "getPublicDiaryPaginationResponse - 최신 일기 조회 (publicDiaryId = 0,createdTime =
// Instant.EPOCH)")
...
//    DiaryPageRequest request = new DiaryPageRequest(999L, Instant.now().plus(10L,
// ChronoUnit.DAYS));
//    when(mockPublicDiaryRepository.findNextContents(
//            any(DiaryPageIndex.class), any(PageRequest.class)))
//        .thenReturn(List.of());
